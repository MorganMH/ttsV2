(function ($) {
  ...
  $(function () {
    ...
    if ($('#sales-statistics-overview').length) {
      ...
      var data_1_1 = [60, 75, 65, 130, 130, 145, 130, 177, 159, ];
      var data_1_2 = [150,134, 123, 132, 120,110, 103, 44];
      var areaData = {
    ...
    if ($("#market-overview-chart").length) {
      ...
      var MarketingChart = new Chart(MarketingChartCanvas, {
        ...
        data: {
          labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug"],
          datasets: [{
              label: 'Volume Count NEW ISSUANCE',
